...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/share/firefox-default-handler/lib
...
SOURCES       = src/firefox-default-handler.cpp moc_Firefox.cpp
OBJECTS       = firefox-default-handler.o \
		moc_Firefox.o
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		firefox-default-handler.pro \
		firefox-default-handler.pro
QMAKE_TARGET  = firefox-default-handler
...
Makefile: firefox-default-handler.pro /usr/share/qt5/mkspecs/linux-g++/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/firefox-default-handler1.0.0 || mkdir -p .tmp/firefox-default-handler1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/firefox-default-handler1.0.0/ && $(COPY_FILE) --parents exec.h Firefox.h .tmp/firefox-default-handler1.0.0/ && $(COPY_FILE) --parents src/firefox-default-handler.cpp .tmp/firefox-default-handler1.0.0/ && $(COPY_FILE) --parents translations/firefox-default-handler-cs_CZ.ts .tmp/firefox-default-handler1.0.0/ && (cd `dirname .tmp/firefox-default-handler1.0.0` && $(TAR) firefox-default-handler1.0.0.tar firefox-default-handler1.0.0 && $(COMPRESS) firefox-default-handler1.0.0.tar) && $(MOVE) `dirname .tmp/firefox-default-handler1.0.0`/firefox-default-handler1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/firefox-default-handler1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_Firefox.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Firefox.cpp
moc_Firefox.cpp: /usr/include/qt5/QtCore/QObject \
...
firefox-default-handler.o: src/firefox-default-handler.cpp /usr/include/qt5/QtQuick/QtQuick \
		...
		/usr/include/qt5/QtCore/QFileInfo \
		exec.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o firefox-default-handler.o src/firefox-default-handler.cpp

moc_Firefox.o: moc_Firefox.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Firefox.o moc_Firefox.cpp

####### Install

install_qm: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/firefox-default-handler/translations || mkdir -p $(INSTALL_ROOT)/usr/share/firefox-default-handler/translations
	lupdate -noobsolete "/home/mersdk/share/firefox-default-handler/src" "/home/mersdk/share/firefox-default-handler/qml" -ts "/home/mersdk/share/firefox-default-handler/translations/firefox-default-handler.ts" "/home/mersdk/share/firefox-default-handler/translations/firefox-default-handler-cs_CZ.ts" && mkdir -p translations && [ "/home/mersdk/share/firefox-default-handler" != "/home/mersdk/share/firefox-default-handler" -a 1 -eq 1 ] && cp -af "/home/mersdk/share/firefox-default-handler/translations/firefox-default-handler-cs_CZ.ts" "/home/mersdk/share/firefox-default-handler/translations" || : ; [ 1 -eq 1 ] && lrelease -nounfinished "/home/mersdk/share/firefox-default-handler/translations/firefox-default-handler-cs_CZ.ts" || :
	-$(INSTALL_FILE) /home/mersdk/share/firefox-default-handler/translations/firefox-default-handler-cs_CZ.qm $(INSTALL_ROOT)/usr/share/firefox-default-handler/translations/

uninstall_qm: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/firefox-default-handler/translations/firefox-default-handler-cs_CZ.qm
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/firefox-default-handler/translations/ 


install_qml: first FORCE
	@test -d $(INSTALL_ROOT)/usr/share/firefox-default-handler || mkdir -p $(INSTALL_ROOT)/usr/share/firefox-default-handler
	-$(INSTALL_DIR) /home/mersdk/share/firefox-default-handler/qml $(INSTALL_ROOT)/usr/share/firefox-default-handler/

uninstall_qml: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/firefox-default-handler/qml
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/firefox-default-handler/ 
...
install_desktop: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/firefox-default-handler/firefox-default-handler.desktop $(INSTALL_ROOT)/usr/share/applications/

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/firefox-default-handler.desktop
...
install_icon: first FORCE
	...
	-$(INSTALL_FILE) /home/mersdk/share/firefox-default-handler/firefox-default-handler.png $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/86x86/apps/firefox-default-handler.png
